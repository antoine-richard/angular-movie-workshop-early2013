...
StaticServlet.prototype.handleRequest = function(req, res) {
  ...
  fs.stat(path, function(err, stat) {
    ...
    if (jsonSubTree)
      return self.sendJsonSubTree_(req, res, path, jsonSubTree);
...
StaticServlet.prototype.sendJsonSubTree_ = function(req, res, path, jsonSubTree) {
  var self = this;
